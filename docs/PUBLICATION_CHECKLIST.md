...
2. Tag: `v9.0.0`
3. Title: `PAMPAr-o1 v9.0.0 - Territorial Architecture`
4. Descripción:
```markdown
## 🦙 PAMPAr-o1 v9.0.0 - Territorial Architecture

### Highlights
- 14M parameters, PPL ~45 on WikiText-103
- Novel territorial architecture with 4 specialized territories
- Hybrid routing: 70% LLAVES (explicit rules) + 30% learned attention
- Trained on consumer hardware (GTX 1650 4GB)
...
### Note
Checkpoints are NOT included due to size. Train with:
```bash
...
- `docs/PUBLICATION_CHECKLIST.md` - Este archivo
