...
def load_wikitext():
    ...
    # Leer por chunks para evitar MemoryError
    print("   Leyendo train (1MB)...")
    with open(train_path, 'r', encoding='utf-8') as f:
        train_text = f.read(1_000_000)  # 1MB para entrenamiento más rápido
    
    print("   Leyendo valid (100KB)...")
    with open(valid_path, 'r', encoding='utf-8') as f:
        valid_text = f.read(100_000)  # 100KB
